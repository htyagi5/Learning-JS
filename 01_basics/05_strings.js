...
const gameName = new String('hitesh-hc-com') //new   keyword used to use the javascript objects we get so many property to apply  apply it on console
...
console.log(newStringOne.trim());//trim helps to remove extra spaces
